        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <h1>Améliorons ensemble<br>
                        les soins de santé</h1>
                    <p>Nous mettons tout en œuvre pour vous offrir un accompagnement médical de qualité, basé sur une
                        approche holistique de votre bien-être. Notre équipe expérimentée est là pour répondre à vos
                        besoins de manière attentionnée et empathique, afin de vous aider à atteindre vos objectifs de
                        santé et à vivre une vie épanouie et équilibrée. </p>
                ...
                <div class="col-md-4">
                    <div class="card card-feature text-center text-lg-left">
                        ...
                        <h3 class="card-feature__title"><span class="card-feature__icon">
                            ...
                            </span>Consultation</h3>
                        <p class="card-feature__subtitle">Nous offrons des consultations personnalisées, avec un suivi
                            attentif de votre santé. Écoute attentive et réponse empathique pour des soins de qualité.
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-feature text-center text-lg-left">
                        ...
                        <h3 class="card-feature__title"><span class="card-feature__icon">
                            ...
                            </span>Soins de qualité</h3>
                        <p class="card-feature__subtitle">Nos soins sont centrés sur l’approche holistique, offrant des
                            traitements adaptés et un accompagnement personnalisé pour améliorer votre bien-être. </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-feature text-center text-lg-left">
                        ...
                        <h3 class="card-feature__title"><span class="card-feature__icon">
                            ...
                            </span>Rendez-vous en ligne</h3>
                        <p class="card-feature__subtitle">Planifiez vos rendez-vous en ligne facilement grâce à notre
                            plateforme intuitive, pour une prise en charge rapide et pratique.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-header" id="headingThree">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                            ...
                                            Quels types de rendez-vous puis-je prendre en ligne ?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div class="card-header" id="headingFour">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                            ...
                                            Est-ce que je peux modifier ou annuler mon rendez-vous en ligne ?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div class="card-header" id="headingFive">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                            ...
                                            Que faire si je ne trouve pas de créneau qui me convient en ligne ?
                                        </button>
                                    </h5>
                                </div>
        ...
        <div class="container">
            <div class="testi_slider owl-carousel owl-theme">
                <div class="item">
                    <div class="testi_item">
                        <div class="testimonial_image">
                            <img src="{{ asset('medcare-master/img/elements/tex2.jpg') }}" alt="">
                        </div>
                ...
                <div class="item">
                    <div class="testi_item">
                        <div class="testimonial_image">
                            <img src="{{ asset('medcare-master/img/elements/user1.png') }}" alt="">
                        </div>
                        <div class="testi_item_content">
                            <p>
                ...
                <div class="item">
                    <div class="testi_item">
                        <div class="testimonial_image">
                            <img src="{{ asset('medcare-master/img/elements/user2.png') }}" alt="">
                        </div>
                        <div class="testi_item_content">
                            <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span>(+212) 634-789546</span>
                    <p class="pt-3">Nous fournissons un support client 24/7. N’hésitez pas à nous contacter <br> en
                        cas d’urgence.</p>
                </div>
            </div>
        </div>
